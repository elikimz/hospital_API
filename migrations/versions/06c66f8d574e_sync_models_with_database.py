...
Revision ID: 06c66f8d574e
Revises: 
Create Date: 2025-02-16 10:28:38.999154
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'DOCTOR', 'NURSE', 'RECEPTIONIST', 'PHARMACIST', 'PATIENT', name='userrole_enum'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
