...
@router.get("/patient/me", response_model=schema.PatientWithUser)
...
@router.put("/patient/me", response_model=schema.PatientWithUser)
def update_patient_info(
    patient_update: schema.PatientUpdate,
    current_user: model.User = Depends(get_current_user),
    db: Session = Depends(database.get_db)
):
    if current_user.role != UserRole.PATIENT:
