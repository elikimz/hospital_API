...
class User(Base):
    ...
    staff_profile = relationship("Staff", back_populates="user", uselist=False, cascade="all, delete")
...
class Appointment(Base):
    ...
    doctor_id = Column(Integer, ForeignKey("staff.id", ondelete="CASCADE"), nullable=False)
    date = Column(DateTime, nullable=False)
