...
#         raise HTTPException(
#             status_code=403,
#             detail="Only admins or receptionists can view the dashboard",
#         )

#     total_patients = db.query(model.Patient).count()
#     total_doctors = (
#         db.query(model.User).filter(model.User.role == UserRole.DOCTOR).count()
#     )
#     total_staff = (
#         db.query(model.User).filter(model.User.role != UserRole.PATIENT).count()
#     )
...
#         raise HTTPException(
#             status_code=403,
#             detail="Only admins or accountants can view financial reports",
#         )
...
#     ]:
#         raise HTTPException(
#             status_code=403, detail="Only authorized staf can view appointments"
#         )
