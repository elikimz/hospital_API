...
@router.put("/appointments/{appointment_id}", response_model=schema.Appointment)
def reschedule_appointment(
    ...
    # Ensure the current user is the patient who owns the appointment
    if appointment.patient_id != current_user.id:
        raise HTTPException(status_code=403, detail="Only the patient can reschedule this appointment")

    # Now you can proceed to update the appointment details
